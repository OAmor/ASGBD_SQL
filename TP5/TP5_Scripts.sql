...
CREATE TABLE HIST_HOSPIT (
	DATE_HOSPIT TIMESTAMP,
	NUM_PATIENT NUMBER(3),
	CODE_SERVICE VARCHAR(10),
	Constraint pk_date Primary key(DATE_HOSPIT,NUM_PATIENT)	
);

CREATE OR REPLACE TRIGGER nouveau_patient_sauv
AFTER INSERT 
ON HOSPITALISATION 
FOR EACH ROW
DECLARE
	temp TIMESTAMP;
BEGIN 
	INSERT INTO HIST_HOSPIT 
	VALUES (CURRENT_TIMESTAMP,:NEW.NUM_PATIENT,:NEW.CODE_SERVICE);
END;
/
